...
export default function DubaiInsideUAEExtensionPrices() {
  return (
    <main>
      <Hero title="Visa Change & Extension Inside UAE" imageUrl={encodeURI("/visa images/VISA EXTENSION DUBAI VISA.jpeg")} subtitle="Extend without exit." />
